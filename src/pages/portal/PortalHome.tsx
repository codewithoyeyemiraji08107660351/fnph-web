...
export function PortalHome() {
  ...
  return <><div className="dashboard-welcome"><div><span className="eyebrow">Welcome back · {principal?.displayName}</span><h1>Your care, in one clear place.</h1><p>Request a non-emergency consultation, follow your approval, enter the live room when it opens and review documents released by the Hub Coordinator.</p></div><div className="welcome-flower" aria-hidden>✦</div></div>
