...
export function PatientConsent({ onDone }: { onDone?: () => void }) {
  ...
  return <><div className="stage-header"><div><span>Safety and consent</span><strong>Read the first-time agreement</strong></div><span className="step-pill">Step 3 of 7</span></div><div className="screen-heading"><span className="eyebrow">First-time service agreement</span><h1>Read the safety and data-protection notice</h1><p>Take your time. Booking-specific safety questions appear again when you request a consultation.</p></div><div className="notice amber"><b>This service is not for emergencies.</b><span>For verified existing patients previously assessed in person and suitable for remote follow-up.</span></div>
